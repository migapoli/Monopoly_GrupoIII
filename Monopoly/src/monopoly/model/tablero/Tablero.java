...
public class Tablero {
    ...
    private void inicializarCasillas() {
        // Casilla 0: Salida
        casillas.add(new CasillaEspecial("Salida", 0, TipoCasilla.SALIDA));
        ...
        casillas.add(new CasillaEspecial("Impuesto sobre la Renta", 4, TipoCasilla.IMPUESTO, 200)); // Impuesto 200
        ...
        // Casilla 10: Cárcel
        casillas.add(new CasillaEspecial("Cárcel", 10, TipoCasilla.CARCEL));
        ...
        casillas.add(new CasillaEspecial("Parking Gratuito", 20, TipoCasilla.PARKING));
        ...
        casillas.add(new CasillaEspecial("Ir a la Cárcel", 30, TipoCasilla.IR_CARCEL));
        ...
        casillas.add(new CasillaEspecial("Impuesto de Lujo", 38, TipoCasilla.IMPUESTO, 100)); // Impuesto 100
